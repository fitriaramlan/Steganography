Public Class frmNoise
    ...
    Private Sub btnBrowse_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBrowse.Click
        If dlgOpenPicture.ShowDialog() = Windows.Forms.DialogResult.OK Then
            Try
                ...
                rtbKunci.LoadFile(dlgOpenPicture.FileName.Substring(0, dlgOpenPicture.FileName.ToString.Length - 4) & ".key", RichTextBoxStreamType.PlainText)
    ...
    Private Sub btnSimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSimpan.Click
        ...
        If dlgSavePicture.ShowDialog() = Windows.Forms.DialogResult.OK Then
            Try
                ...
                rtbKunci.SaveFile(dlgSavePicture.FileName.Substring(0, dlgSavePicture.FileName.ToString.Length - 4) & ".key", RichTextBoxStreamType.TextTextOleObjs)
            Catch ex As Exception
                MessageBox.Show(ex.Message)
            End Try
        End If
    ...
    Private Sub btnProses_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnProses.Click
        ...
        ' Revisi Terakhir
        '-------------------------------------
        If (OriImage.Width * OriImage.Height) < CInt(0 & txtNoise.Text) Then
            MsgBox("Jumlah noise melebihi ukuran citra !", MsgBoxStyle.Critical)
            Exit Sub
        End If
        '-------------------------------------
